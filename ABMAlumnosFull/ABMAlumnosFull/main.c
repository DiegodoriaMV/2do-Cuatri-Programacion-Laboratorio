...
int menuInformes()
{
    ...
    printf("9-mostrar almuerzo en fecha determinada\n");
    printf("10- \n");
    printf("11-lista de almuerzo x carrera\n");
    printf("12-CARRERA AMANTE DE LAS MINAL\n");
    printf("13-informe deuda de alumno \n");
    printf("20-Salir\n\n");
    printf("Ingrese opcion: ");
    scanf("%d", &opcion);
